    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="engine" class="block mt-1 w-full" type="number" step=".1" name="engine" value="{{$car->engine}}" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                rounded-md shadow-sm">
                    ...
                    @if($car->brand == $brand->id) selected @endif>{{$brand->name}}</option>
                    @endforeach
                </select>
            </div>
